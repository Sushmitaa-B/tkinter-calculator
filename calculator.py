...
button_equal=Button(root, text="=",padx=48,pady=25, command=equal,fg="white", bg="blue")
button_sub=Button(root, text="-", padx=50, pady=25, command=sub)
button_divide=Button(root, text="/", padx=50, pady=25, command=divide)
button_multiply=Button(root, text="*", padx=50, pady=25, command=multiply)
